...
namespace MonkeRotate.Patch
{
    ...
    internal static class RotationPatch
    {
                                                                                      ...
                                                                                      ref RaycastHit ___junkHit)
        {
            ...
            funcParems = new object[] { __instance.leftControllerTransform,
            ...
            funcParems = new object[] { __instance.rightControllerTransform,
            ...
            if (__instance.leftHandSlide || __instance.rightHandSlide) {
                ...
                if (___touchPoints == 1) {
                    ___surfaceDirection = __instance.rightHandSlide ? Vector3.ProjectOnPlane(__instance.rightControllerTransform.forward, __instance.rightHandSlideNormal) : Vector3.ProjectOnPlane(__instance.leftControllerTransform.forward, __instance.leftHandSlideNormal);
            ...
            if ((___rightHandColliding || ___leftHandColliding) && !__instance.disableMovement && !__instance.turnedThisFrame) {
                                                                       ...
                                                                       ref Photon.Realtime.Player ___tempPlayer)
        {
            ...
            if (!__instance.isOfflineVRRig && (__instance.photonView == null || __instance.photonView.Owner == null || (__instance.photonView.Owner != null && PhotonNetwork.CurrentRoom.Players.TryGetValue(__instance.photonView.Owner.ActorNumber, out ___tempPlayer) && ___tempPlayer == null))) {
                ...
                if(__instance.photonView != null) {
                    GorillaParent.instance.vrrigDict.Remove(__instance.OwningNetPlayer);
                }
            ...
            // networked other player sync / lerp stuff
                ...
                if (!__instance.initializedCosmetics && GorillaTagManager.instance != null && GorillaTagManager.instance.co.TryGetValue(__instance.photonView.Owner.UserId, out __instance.tempString)) {
        ...
        internal static bool RotatePlayer(GorillaLocomotion.Player __instance, ref float degrees, ref Vector3 ___denormalizedVelocityAverage, ref Vector3[] ___velocityHistory)
        {
            ...
            __instance.turnedThisFrame = true;
